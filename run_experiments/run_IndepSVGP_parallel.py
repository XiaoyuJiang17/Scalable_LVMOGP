...
from code_blocks.our_models.Multi_ISVGP import Multi_Variational_IGP_parallel
import torch
import numpy as np
import random
import yaml
...
if __name__ == "__main__":
    ...
    ### Define Model
    MultiIGP = Multi_Variational_IGP_parallel(
    ...
    train_and_eval_multiIndepSVGP_parallel(
...
# This implementation has multiprocessing issue ... must be improved if one want to use  
    # TODO:
    # see if the code runable when number of output is small
    # try if the code for example (given in gpytorch) runable when the number of output is high  